...
SELECT id, 'Body Type', 'body_type', 'select', 
  '[\"Sedan\",\"Hatchback\",\"SUV\",\"Coupe\",\"Convertible\",\"Wagon\",\"Van\",\"Pickup Truck\",\"Minivan\",\"Limuzina\",\"Crossover\",\"Sports Car\",\"Luxury Car\"]',
  0, 1, 6, NOW(), NOW()
FROM categories WHERE slug='auto'
ON DUPLICATE KEY UPDATE 
  options_json='[\"Sedan\",\"Hatchback\",\"SUV\",\"Coupe\",\"Convertible\",\"Wagon\",\"Van\",\"Pickup Truck\",\"Minivan\",\"Limuzina\",\"Crossover\",\"Sports Car\",\"Luxury Car\"]',
  updated_at=NOW();
" 2>/dev/null
