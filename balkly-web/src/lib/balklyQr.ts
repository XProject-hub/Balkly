...
export async function generateBalklyQR(
  ...
  // ── Draw data modules (skip eye zones) ──────────────────────────────────────
  ...
  // ── Draw the three finder (eye) patterns ─────────────────────────────────────
  ...
  // Logo background – dark rounded square with subtle border
