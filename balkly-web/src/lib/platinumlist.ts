...
const MOCK_PLATINUMLIST_EVENTS: PlatinumListEvent[] = [
  ...
  // Additional attractions from Platinumlist
  {
    ...
    image_url: 'https://cdn.pixabay.com/photo/2016/07/30/00/03/water-park-1556670_1280.jpg',
  ...
  },
  {
    ...
    image_url: 'https://cdn.pixabay.com/photo/2016/11/29/05/45/adventure-1867513_1280.jpg',
  ...
  },
  {
    ...
    image_url: 'https://cdn.pixabay.com/photo/2017/07/21/23/57/pool-2526977_1280.jpg',
  ...
  },
  {
    ...
    image_url: 'https://cdn.pixabay.com/photo/2018/10/30/16/06/water-3784950_1280.jpg',
    venue: 'Dubai Marina',
    city: 'Dubai',
    country: 'AE',
