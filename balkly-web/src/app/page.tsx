        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 sm:gap-4">
            {[
              ...
              { href: "/beauty",      icon: <Star className="h-6 w-6 sm:h-7 sm:w-7 text-balkly-blue" />,      title: t.home.catBeauty,      desc: t.home.catBeautyDesc },
              { href: "/sports",      icon: <TrendingUp className="h-6 w-6 sm:h-7 sm:w-7 text-balkly-blue" />,      title: t.home.catSports,      desc: t.home.catSportsDesc },
              { href: "/home-garden", icon: <Building2 className="h-6 w-6 sm:h-7 sm:w-7 text-balkly-blue" />,        title: t.home.catHomeGarden,  desc: t.home.catHomeGardenDesc },
              { href: "/services",    icon: <Briefcase className="h-6 w-6 sm:h-7 sm:w-7 text-balkly-blue" />,      title: t.home.catServices,    desc: t.home.catServicesDesc },
              { href: "/baby-kids",   icon: <User className="h-6 w-6 sm:h-7 sm:w-7 text-balkly-blue" />,         title: t.home.catBabyKids,    desc: t.home.catBabyKidsDesc },
              { href: "/health",      icon: <MapPin className="h-6 w-6 sm:h-7 sm:w-7 text-balkly-blue" />,         title: t.home.catHealth,      desc: t.home.catHealthDesc },
