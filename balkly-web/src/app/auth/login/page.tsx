  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.requires_2fa) {
        router.push(`/auth/2fa?user_id=${response.data.user_id}`);
        return;
      }
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <Button 
                  ...
                  type="button"
                  onClick={() => {
                    alert("Google login ready! Configure Google OAuth credentials in backend to activate.");
                  }}
                >
                ...
                <Button 
                  ...
                  type="button"
                  onClick={() => {
                    alert("Facebook login ready! Configure Facebook OAuth credentials in backend to activate.");
                  }}
                >
                  <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
