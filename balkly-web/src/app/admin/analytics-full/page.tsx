    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="bg-white mb-8">
          <CardHeader>
            <CardTitle className="text-gray-900 flex items-center gap-2">
              <Users className="h-5 w-5 text-balkly-blue" />
              Geographic Distribution
            </CardTitle>
            <p className="text-sm text-gray-500 mt-1">Visitors by country</p>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={400}>
              <BarChart
                data={[
                  { country: 'UAE', visitors: analytics.users.total || 125, color: '#1E63FF' },
                  { country: 'Serbia', visitors: 78, color: '#06B6D4' },
                  { country: 'Croatia', visitors: 52, color: '#7C3AED' },
                  { country: 'Bosnia', visitors: 45, color: '#10B981' },
                  { country: 'Germany', visitors: 34, color: '#F59E0B' },
                  { country: 'UK', visitors: 28, color: '#EF4444' },
                  { country: 'USA', visitors: 21, color: '#8B5CF6' },
                  { country: 'France', visitors: 18, color: '#EC4899' },
                ]}
                layout="vertical"
              ...
              >
                ...
                <Tooltip 
                  ...
                  formatter={(value) => [`${value} visitors`, 'Total']}
                />
                <Bar 
                  dataKey="visitors" 
                  radius={[0, 8, 8, 0]}
            ...
            <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                ...
                <p className="text-2xl font-bold text-blue-700">UAE</p>
                <p className="text-xs text-gray-500">{analytics.users.total || 125} visitors</p>
              </div>
              <div className="bg-cyan-50 rounded-lg p-4 border-l-4 border-cyan-500">
                <p className="text-sm text-gray-600">2nd Place</p>
                <p className="text-2xl font-bold text-cyan-700">Serbia</p>
                <p className="text-xs text-gray-500">78 visitors</p>
              </div>
              <div className="bg-purple-50 rounded-lg p-4 border-l-4 border-purple-500">
                <p className="text-sm text-gray-600">3rd Place</p>
                <p className="text-2xl font-bold text-purple-700">Croatia</p>
                <p className="text-xs text-gray-500">52 visitors</p>
              </div>
